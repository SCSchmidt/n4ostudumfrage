...
`r sum(rl$FAIR, na.rm = TRUE)` Leute nennen die FAIR-Prinzipien.

`r sum(rl$IANUS, na.rm = TRUE)` Leute nennen die IANUS-IT-Empfehlungen.

`r sum(rl$drei_zwei_eins, na.rm = TRUE)` Leute nennen die 3-2-1-Back-Up-Strategien.
